...
!(async () => {
  if (!cookiesArr[0]) {
   ...
   await getAuthorShareCode('https://raw.githubusercontent.com/dantes1016/gaqd/main/shareCodes/jd_zz.json');
   await getAuthorShareCode('https://ghproxy.com/https://raw.githubusercontent.com/dantes1016/gaqd/main/shareCodes/jd_zz.json');
   //await getRandomCode();
