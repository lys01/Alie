...
function updateShareCodesCDN(url = 'https://ghproxy.com/https://raw.githubusercontent.com/dantes1016/gaqd/main/shareCodes/jd_cityShareCodes.json') {
  return new Promise(resolve => {
...
function readShareCode() {
  ...
  return new Promise(async resolve => {
    $.get({url: "https://raw.githubusercontent.com/dantes1016/gaqd/main/shareCodes/jd_cityShareCodes.json",headers:{
